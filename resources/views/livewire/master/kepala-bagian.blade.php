                                        ...
                                        <div x-cloak x-show="modelOpen"
                                            ...
                                            <form class="mt-5" wire:submit.prevent="save">
                                                <div>
                                                    ...
                                                    <input wire:model="nama" placeholder="Masukan Nama Bagian"
                                                        type="text"
                                                ...
                                                <div class="mt-4">
                                                    <label for="email"
                                                        class="block text-sm text-gray-700 capitalize dark:text-gray-200">Nama
                                                        Kepala Bagian <span class="text-red-500">*</span></label>
                                                    <input wire:model="kepala" placeholder="Masukan Nama Kepala Bagian"
                                                        type="text"
                                                        class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                                                    @error('kepala')
                                                        <span class="text-red-300">{{ $message }}</span>
                                                ...
                                                <div class="mt-4">
                                                    <label for="email"
                                                        ...
                                                        Bagian <span class="text-red-500">*</span></label>
                                                    <input wire:model="kode" placeholder="Masukan Kode Bagian"
                                                        type="text"
                                                        class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                                                    @error('kode')
                                                        <span class="text-red-300">{{ $message }}</span>
                            ...
                            <tbody>
                                @foreach ($bagian as $key => $value)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3 text-green-500" style="width: 30%">{{ $value->kepala }}</td>
