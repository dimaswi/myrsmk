            ...
            <li x-data="{ menuLogistik: false }" class="relative px-6 py-3  text-gray-800 dark:text-gray-100">
                ...
                <template x-if="menuLogistik">
                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        aria-label="submenu">
                            <li
                                class="px-2 py-1 transition-colors duration-150 @if (request()->routeIs('logistik')) text-gray-800 dark:text-gray-100 @endif
                                hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full" href="{{ route('logistik') }}">{{ __('Logistik') }}</a>
                            </li>
                ...
                <li x-data="{ menuAdmin: false }" class="relative px-6 py-3  text-gray-800 dark:text-gray-100">
                    ...
                    <template x-if="menuAdmin">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            ...
                            <li
                                class="px-2 py-1 transition-colors duration-150 @if (request()->routeIs('admin_ip')) text-gray-800 dark:text-gray-100 @endif
                            hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full" href="{{ route('admin_ip') }}">{{ __('IP Info') }}</a>
                            </li>
                        </ul>
                    </template>
                </li>
